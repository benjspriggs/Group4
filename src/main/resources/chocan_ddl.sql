...
ALTER TABLE entity_lookup ADD FOREIGN KEY (MEMBER_NUMBER) REFERENCES members (NUMBER) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE entity_lookup ADD FOREIGN KEY (PROVIDER_NUMBER) REFERENCES providers (NUMBER) ON DELETE CASCADE ON UPDATE CASCADE;
CREATE INDEX ENTITY_LOOKUP_MEMBERS_NUMBER_FK ON entity_lookup (MEMBER_NUMBER);
CREATE INDEX ENTITY_LOOKUP_PROVIDERS_NUMBER_FK ON entity_lookup (PROVIDER_NUMBER);
ALTER TABLE locations_lookup ADD FOREIGN KEY (LOCATION_ID) REFERENCES locations (ID) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE locations_lookup ADD FOREIGN KEY (ENTITY_ID) REFERENCES entity_lookup (ID) ON DELETE CASCADE ON UPDATE CASCADE;
