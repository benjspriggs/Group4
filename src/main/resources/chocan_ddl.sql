...
(
  ...
  IS_SUSPENDED SMALLINT DEFAULT false
);
...
(
  PROVIDER_NUMBER INT PRIMARY KEY NOT NULL,
  CONSTRAINT PROVIDER_INFO_PROVIDERS_NUMBER_FK FOREIGN KEY (PROVIDER_NUMBER) REFERENCES PROVIDERS (NUMBER)
);
